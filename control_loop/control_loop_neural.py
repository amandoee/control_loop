...
class AckermannLineFollower(Node):
    def __init__(self):
        ...
        self.estimate_neural = self.create_subscription(LaserScan, 'scan', self.estimate_pose_neural, 0)
        self.scan_sub = self.create_subscription(LaserScan, 'scan', self.scan_callback, 0)
    ...
    def estimate_pose_neural(self, msg):
        ...
        if self.old_scan is not None:
            ...
            print("Predicted x: ",self.current_x)
            print("Predicted y: ",self.current_y)
            print("Predicted yaw: ",self.current_yaw)
    ...
    def control_loop(self):
        ...
        msg.drive.speed = 4.0  # Constant speed; adjust as needed
